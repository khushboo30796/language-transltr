...
if(isset($_POST["load"]) || isset($_POST["upd"]) || isset($_POST["up"])){
	...
	echo '</select>
        ...
        { 
            ...
            $qf='select fid from author_journal where title="'.$_POST["title"].'";';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
            $qfname='select fname from faculty where fid='.$fi;
            $resfname=$conn->query($qfname);
            $rowfname=$resfname->fetch_row();
            $res2=$conn->query($q);
            $row=$res2->fetch_row();
            
            $tb2='<table > <tr> <td> jname </td> <td> <input type="text" name="jname" value="'.$row[0].'"readonly > </td> </tr> <tr> <td> title </td> <td> <input type="text" name="title" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> acad yr </td> <td> <input type="text" name="acadyear" value="'.$row[2].'"readonly > </td> </tr>
          <tr> <td> pub year </td> <td> <input type="text" name="pubyear" value="'.$row[3].'"readonly > </td> </tr>
          <tr> <td> issue </td> <td> <input type="text" name="issue" value="'.$row[4].'"readonly > </td> </tr>
          <tr> <td> vol </td> <td> <input type="text" name="vol" value="'.$row[5].'" readonly> </td> </tr>
          <tr> <td> pg start </td> <td> <input type="text" name="pgstart" value="'.$row[6].'" readonly> </td> </tr>
          <tr> <td> pg end </td> <td> <input type="text" name="pgend" value="'.$row[7].'" readonly> </td> </tr>
          <tr> <td> url </td> <td> <input type="text" name="url" value="'.$row[8].'" readonly> </td> </tr>
          <tr> <td> Faculty name: </td> <td> <input type="text" name="url" value="Dr.Ramesh Balaji" readonly> </td> </tr>
           ...
           {
           	echo "<br>".$tb2."<br>";
           	echo "<input type='submit' name='up' value='OK'>";
           }	
	...
	echo '</select>
        ...
        { 
            ...
            $q='select * from patents where patent_no='.$_POST["pno"].';';
             $qf='select fid from invents where patent_no='.$_POST["pno"].';';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
            ...
            $tb2='<table > <tr> <td> title </td> <td> <input type="text" name="titlep" value="'.$row[0].'" readonly> </td> </tr>
          <tr> <td> patent no </td> <td> <input type="text" name="pno" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> pub date </td> <td> <input type="text" name="pubdate" value="'.$row[2].'" readonly> </td> </tr>
          <tr> <td> acad year </td> <td> <input type="text" name="acadyearp" value="'.$row[3].'"readonly > </td> </tr>
          <tr> <td> Faculty name: </td> <td> <input type="text" name="url" value="'.$rowfname[0].'" readonly> </td> </tr>
           </table> ';
	...
	echo '</select>
       ...
       if(isset($_POST["upd"]) || isset($_POST["up"]))
        { 
            ...
            //echo $q;
            $qf='select fid from author_book where title="'.$_POST["titleb"].'";';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
          ...
          <tr> <td> publisher </td> <td> <input type="text" name="publisherb" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> pub year </td> <td> <input type="text" name="pubyearb" value="'.$row[2].'" readonly> </td> </tr>
          <tr> <td> acad year </td> <td> <input type="text" name="acadyearb" value="'.$row[3].'" readonly> </td> </tr>
          <tr> <td> url </td> <td> <input type="text" name="urlb" value="'.$row[4].'" readonly> </td> </tr>
          <tr> <td> Faculty author: </td> <td> <input type="text" name="url" value="'.$rowfname[0].'" readonly> </td> </tr>
	...
	echo '</select>
       ...
       if(isset($_POST["upd"]) || isset($_POST["up"]))
        { 
            ...
            //echo $q;
            $qf='select fid from author_conf where title="'.$_POST["titlec"].'";';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
          ...
          <tr> <td> conf. name </td> <td> <input type="text" name="confname" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> place </td> <td> <input type="text" name="place" value="'.$row[2].'" readonly> </td> </tr>
          <tr> <td> conf date </td> <td> <input type="text" name="date" value="'.$row[3].'" readonly> </td> </tr>
          <tr> <td> acad year </td> <td> <input type="text" name="acadyearc" value="'.$row[4].'" readonly> </td> </tr>
          <tr> <td> pg no </td> <td> <input type="text" name="pgno" value="'.$row[5].'" readonly> </td> </tr>                    
          <tr> <td> Faculty author: </td> <td> <input type="text" name="url" value="'.$rowfname[0].'" readonly> </td> </tr>
...
$tb='<table >
	...
	echo '</select>
        ...
        {  
            ...
            $qf='select fid from author_book_chapter where book_title="'.$_POST["titlebc"].'" and ch_title="'.$_POST["chtitle"].'" ;';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
          ...
          <tr> <td> editor </td> <td> <input type="text" name="editor" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> chapter title </td> <td> <input type="text" name="chtitle" value="'.$row[2].'" readonly > </td> </tr>
          <tr> <td> pub year </td> <td> <input type="text" name="pubyearbc" value="'.$row[3].'" readonly> </td> </tr>
          <tr> <td> acad year </td> <td> <input type="text" name="acadyearbc" value="'.$row[4].'" readonly> </td> </tr>
          <tr> <td> publisher </td> <td> <input type="text" name="publisherbc" value="'.$row[5].'" readonly> </td> </tr> 
          <tr> <td> url </td> <td> <input type="text" name="urlbc" value="'.$row[6].'" readonly> </td> </tr>                             
          <tr> <td> Faculty name: </td> <td> <input type="text" name="fid" value="'.$rowfname[0].'" readonly> </td> </tr>
...
$tb='<table >
	...
	echo '</select>
        ...
        { 
            ...
            //echo $q;
            $qf='select fid from investigator where title="'.$_POST["titlepro"].'";';
            //echo $qf;
            $resf=$conn->query($qf);
            $rowf=$resf->fetch_row();
            $fi=$rowf[0];
          ...
          <tr> <td> Project Sponsor </td> <td> <input type="text" name="sponsor" value="'.$row[1].'" readonly> </td> </tr>
          <tr> <td> Start Date </td> <td> <input type="text" name="sdate" value="'.$row[2].'" readonly> </td> </tr>
          <tr> <td> End Date (Blank if ongoing) </td> <td> <input type="text" name="edate" value="'.$row[3].'" readonly> </td> </tr>
          <tr> <td> Budget</td> <td> <input type="text" name="budget" value="'.$row[4].'"readonly > </td> </tr>
          <tr> <td> Project Type </td> <td> <input type="text" name="typepro" value="'.$row[5].'" readonly> </td> </tr>                    
          <tr> <td> Faculty head: </td> <td> <input type="text" name="url" value="'.$rowfname[0].'" readonly> </td> </tr>
